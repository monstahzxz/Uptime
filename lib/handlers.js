...
handlers.index = function(data,callback){
	if(data.method == 'get'){
		var templateData = {
			...
			'head.description' : 'We offer free, simple uptime monitoring',
			'body.class' : 'index'
		};
...
handlers._checks.post = function(data,callback){
	...
	var method = typeof(data.payload.method) == 'string' && ['put','get','put','delete'].indexOf(data.payload.method) > -1 ? data.payload.method : false;
