...
cli.responders.help = function(){
	var commands = {
		...
		'list checks --up --down' : 'Show a list of active checks in the system, including their state. The --up and the --down flags are both optional',
...
cli.responders.stats = function(){
	var stats = {
		...
		'Curent Malloced Memory' : v8.getHeapStatistics().malloced_memory,
